...
const Footer = () => {
  return (
    <div className="mt-auto my-1 mx-1">
      <footer className="footer  flex flex-col sm:flex-row bg-neutral text-neutral-content justify-between items-center p-4 ">
        ...
        <div className="flex  text-[40px] m-1">
          <div>
